module.exports = nativeDescription: "简体中文", englishDescription: "Chinese (Simplified)", translation:
  new_home:
    ...
    getting_students: "让学生尽快动手编写代码来学习程序语法和合适的结构是至关重要的。"
    educator_resources: "教学
    .资源"
    course_guides: "和课程指导"
    ...
    feedback: "代码的实时反应，使学生即时调整解决方法，优化代码，从整体理解概念，而不局限于正确或者错误的答案。"
  ...
  diplomat_suggestion:
    ...
    pitch_body: "我们开发了英文版的CodeCombat，但是CodeCombat的玩家遍布全球。对于不熟悉英语的中文玩家，他们希望能玩简体中文版的CodeCombat，如果您中英文都很熟练，请考虑加入我们外交官行列并参与CodeCombat的翻译，帮忙把CodeCombat网站和所有关卡翻译成简体中文。感谢！"
...
#    teacher_email_announcements: "Keep me updated on new teacher resources, curriculum, and courses!"
    ...
    teacher_list_add_students: "通过点击查看班级按钮来增加学生，之后将班级代码或者URL发送给学生。如果他们有邮箱，也可通过邮箱邀请。"
...
#    finished_hoc: "I'm finished with my Hour of Code"
    ...
    tip_impossible: "在事情未完成之前，一切都看似不可能。 - 纳尔逊曼德拉"
    ...
    tip_internet_weather: "拥抱美好的因特网吧，我们早已习惯了这个晴朗的天空。 - 约翰格林"
    tip_nerds: "没人反对疯子的爱好，比如在椅子上蹿下跳不能自已这样的。 - 约翰格林"
    tip_self_taught: "我教会自己90%的知识，再正常不过了！ - Hank Green"
    tip_luna_lovegood: "别担心，你和我一样理智。 - 卢娜洛夫古德《哈利波特》"
    tip_good_idea: "想到一个好主意的最佳方法是想到一堆主意。 - 莱纳斯卡尔鲍林"
    tip_programming_not_about_computers: "计算机科学就是有关计算机的，正如天文学就是有关望远镜的。 - 艾兹格迪杰斯特拉"
    tip_mulan: "相信你能行，你就能做到。 - 迪士尼《花木兰》"
    project_complete: "关卡完成！"
    share_this_project: "和你的朋友家人分享这个项目吧 "
    ready_to_share: "准备好发布你的项目吗？"
    click_publish: "点击发布按钮，让它出现在课堂展览中。你可以检查你的同学们创建的内容。你可以回来继续在这个项目中工作。未来任何的改变都会自动被保存并且分享给你的同学们！"
...
#    choose_instructions: "Select the course from the dropdown menu youd like to assign, then click Assign to Selected Students."
...
#    footer: "When teachers revoke licenses from students, the licenses will be returned to the shared pool for other teachers in this group to use."
  ...
  account_prepaid:
    ...
    purchase_code4: "订阅码适用于玩独立版CodeCombat的帐户，不能代替课堂版本的学生许可。"
